    ...
    <div class="content">   
      ...
      <section class="project-details">
        ...
        if($result){
          ...
          <div class='row'>
            <div class='project-details-info wow fadeIn$position'>
              <h3 class='project-details-title'>
              $name
              </h3>
              <p class='project-details-descr'>$description</p>
            </div>
            <div class='project-details-img col-md-8  $class'>
              <img alt=$name class='img-responsive' src='admin/$image'>
            </div>
          </div>
        </div>
          ";
